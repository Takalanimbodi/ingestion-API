...
This project provides a **Python API** to inset data from CSV or json, storing results into raw_customer_events table in a PostgreSQL database-supabase.  

## HOW TO USE IT:
- open the /ingestion_layer post for your prefered data format.
...
INGESTION_API=.  https://ingestion-api-5.onrender.com/docs
